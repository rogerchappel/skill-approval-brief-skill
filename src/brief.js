...
const MUTATING_ACTION_VERBS = /^(?:(?:add|assign|comment|deploy|fork|grant|label|lock|open|post|publish|reopen|unassign|unlabel|unlock|upload)(?:s|ed|ing)?|approv(?:e|es|ed|ing)|archiv(?:e|es|ed|ing)|clos(?:e|es|ed|ing)|commit(?:s|ted|ting)?|creat(?:e|es|ed|ing)|delet(?:e|es|ed|ing)|disabl(?:e|es|ed|ing)|edit(?:s|ed|ing)?|enabl(?:e|es|ed|ing)|invit(?:e|es|ed|ing)|merg(?:e|es|ed|ing)|modif(?:y|ies|ied|ying)|push(?:es|ed|ing)?|remov(?:e|es|ed|ing)|renam(?:e|es|ed|ing)|repl(?:y|ies|ied|ying)|restor(?:e|es|ed|ing)|revok(?:e|es|ed|ing)|schedul(?:e|es|ed|ing)|send(?:s|ing)?|sent|stars?|starred|starring|submit(?:s|ted|ting)?|transfer(?:s|red|ring)?|unstars?|unstarred|unstarring|updat(?:e|es|ed|ing)|writ(?:e|es|ten|ing))\b/i;
